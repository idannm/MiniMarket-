...
def webhook():
    ...
    try:
        if 'messages' in data['entry'][0]['changes'][0]['value']:
            ...
            3. תעשה שכל פעם אחריי שהוא הזמין תשאל מה הכתובת והשם שלו ואם הוא אומר לך שהוא הזמין והשם והכתובת האחרונה תשאל את השם והכתובת ותבקש אישור ואם הוא מאשר תשלח עם השם והכתובת הזאת
